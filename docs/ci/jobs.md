...
| `CI` | `lint` | Runs RuboCop for style and static checks. | Ruby 3.2, 3.3, 3.4 matrix. |
...
| `CI` | `test` | Runs main RSpec suite (sqlite mode by default) and uploads coverage artifacts. | Redis service; Ruby 3.2, 3.3, 3.4 matrix. |
